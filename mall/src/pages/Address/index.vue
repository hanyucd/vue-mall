  ...
  <div>
    ...
    <div class="container">
      <div class="checkout-addr">
        ...
        <!-- 购物地址 -->
        <section class="page-title-normal checkout-title">
          <h2><span>购物地址</span></h2>
        </section>
        <!-- 地址列表 -->
        <section class="addr-list-wrap">
          <div class="addr-list">
            <ul>
              <li 
              ...
              >
                <dl>
                  ...
                  <dd class="tel"><span style="color: #999">电话：</span>{{ item.tel }}</dd>
                </dl>
        ...
        <section class="shipping-method-wrap">
          <div class="shipping-method">
            <ul>
              <li class="check">
                <div class="name">标准运输</div>
                <div class="price">自由</div>
